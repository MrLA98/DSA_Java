...
#### 9.6 平衡二叉树 - AVL树
  - 算法 - AVL、红黑树、替罪羊树等
  - 左旋算法
    - 新节点，左=头左，右=头右.左，值=头值
    - 头值=头右.值，头左=新节点，头右=头右.右

  - 右旋算法
    - 新节点，右=头右，左=头左.右，值=头值
    - 头值=头左.值，头右=新节点，头左=头左.左
...
- B树
  ...
  - 2-3树
    - 所有的叶子节点都在同一层 
    - 二节点有一个数据，要么没有节点，要么有两个节点
    - 三节点有两个数据，要么没有节点，要么有三个节点
  - 2-3-4树
- B+树
  - 所有的数据都在叶子节点中
    - 非叶子节点中的数据为索引 -- 稀疏索引
